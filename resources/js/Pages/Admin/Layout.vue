<template>
    <div class="flex flex-no-wrap bg-white">
        ...
        <div class="w-64 absolute sm:relative bg-gray-800 shadow h-screen flex-col justify-between hidden sm:flex">
            <div class="px-8">
                ...
                <ul class="mt-12">
                    ...
                    <Link  :href="route('admin.statistic')" class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm ml-2">Statistique</span>
                        </div>
                        
                    </Link >
                    <Link :href="route('admin.recharge')" class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm ml-2">Recharge</span>
                        </div>
                    </Link>
                    <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm ml-2">Bannir</span>
                        </div>
                    </li>
                    ...
                    <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm ml-2">News</span>
                        </div>
                    </li>
                    <Link :href="route('admin.logout')" class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm ml-2">Déconnexion</span>
                        </div>
                    </Link>
                </ul>
        ...
        <div class="w-64 z-40 absolute bg-gray-800 shadow h-screen flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
            ...
            <div id="closeSideBar" class="h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white" @click="sidebarHandler(false)">
                ...
                <ul class="mt-12">
                    <li class="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <div class="flex items-center">
                            ...
                            <Link :href="route('admin.dashboard')" class="text-sm ml-2">Dashboard</Link>
                    ...
                    <Link :href="route('admin.logout')" class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-stack" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                                <polyline points="12 4 4 8 12 12 20 8 12 4" />
                            ...
                            <span class="text-sm ml-2">Deconnexion</span>
                        </div>
                    </Link>
